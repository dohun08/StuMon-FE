...
export default function First({LeaveData} :  {LeaveData : LeaveEntry[]}) {
 const elements = [
  { id: 1, name: "창의디자인실", x: 23, y: 13, width: 7, height: 6, whether:true},
  ...
  { id: 8, name: "인공지능개발실", x: 57, y: 13, width: 8, height: 6 , whether:true},
  ...
  { id: 17, name: "방풍실", x: 81, y: 43.5, width: 5, height: 8 , whether:true},
  ...
  { id: 31, name: "모바일웹개발실", x: 33.7, y: 80.5, width: 5.5, height: 7.5, whether:true},
  { id: 32, name: "소프트웨어공학실", x: 39.2, y: 80.5, width: 5.5, height: 7.5 , whether:true},
  { id: 33, name: "데이터네트워크실", x: 44.7, y: 80.5, width: 5.5, height: 7.5 , whether:true},
