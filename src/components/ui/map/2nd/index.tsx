...
export default function Second({LeaveData} :  {LeaveData : LeaveEntry[]}) {
 const elements = [
  ...
  { id: 9, name: "객체지향프로그래밍실", x: 57, y: 13, width: 8, height: 6, whether : true},
  ...
  { id: 34, name: "IOT자동제어실", x: 18, y: 46.5, width: 5, height: 8, whether : true},
  { id: 35, name: "마이크로프로세서실", x: 18, y: 54.5, width: 5, height: 8, whether : true},
  { id: 36, name: "임베디드시스템실", x: 18, y: 62.5, width: 5, height: 8, whether : true},
  { id: 37, name: "글누리", x: 12, y: 26, width: 5, height: 13, whether : true},
  { id: 38, name: "방풍실", x: 23, y: 21, width: 5, height: 6, whether : true},
